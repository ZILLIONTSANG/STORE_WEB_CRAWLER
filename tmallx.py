...
r1=requests.get('https://rate.tmall.com/list_detail_rate.htm?itemId=537808595989&spuId=837695373&sellerId=3075989694&order=3&currentPage=10&...%20&callback=jsonp1278')
print('testr1:',r1.data)
...
def getRateDetail(itemId,currentPage):
    ...
    print('c = r.data.decode(\'GB18030\'):',c)
